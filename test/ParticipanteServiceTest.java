...
public class ParticipanteServiceTest {
    ...
    public void testListarTodos() {
        Participante p1 = new Participante(1, "João", "M", "joao@email.com", "9999-9999", null, null);
        Participante p2 = new Participante(2, "Maria", "F", "maria@email.com", "8888-8888", null, null);
    ...
    public void testBuscarPorId() {
        Participante participante = new Participante(1, "João", "M", "joao@email.com", "9999-9999", null, null);
    ...
    public void testInserir() {
        when(participanteDaoMock.inserir("Ana", "F", "ana@email.com", "7777-7777", null, null)).thenReturn("sucesso");

        String resultado = participanteService.inserir("Ana", "F", "ana@email.com", "7777-7777");

        assertEquals("sucesso", resultado);
        verify(participanteDaoMock).inserir("Ana", "F", "ana@email.com", "7777-7777", resultado, resultado);
    }

    @Test
    public void testAtualizarParticipante() {
        when(participanteDaoMock.atualizarParticipante(1, "Ana", "F", "ana@email.com", "7777-7777", null))
        ...
        verify(participanteDaoMock).atualizarParticipante(1, "Ana", "F", "ana@email.com", "7777-7777", resultado);
    }
}
